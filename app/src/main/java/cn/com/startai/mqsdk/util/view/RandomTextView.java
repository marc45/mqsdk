package cn.com.startai.mqsdk.util.view;
...
public class RandomTextView extends FrameLayout
    ...
    private HashMap<String, Boolean> textMaps = new HashMap<>();
    private String TAG = RandomTextView.class.getSimpleName();

    public interface OnRippleViewClickListener {
        void onRippleViewClicked(View view, String keywords);
    }
...
//        this.removeAllViews();
        ...
        if (width > 0 && height > 0 && vecKeywords != null && vecKeywords.size() > 0) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                final String keyword = vecKeywords.get(i);
                Boolean aBoolean = textMaps.get(keyword);
                if (aBoolean != null && aBoolean) {
                    continue;
                }
                textMaps.put(keyword, true);
                // 随机颜色  
                ...
                txt.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View view) {
                        if (onRippleOutViewClickListener != null)
                            onRippleOutViewClickListener.onRippleViewClicked(view, keyword);
                    }
                });
                txt.setText(keyword);
